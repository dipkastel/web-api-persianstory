...
tinymce.init({
  ...
  toolbar: \'undo redo | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist | image\',
  content_css: [
...
'
		...
		$this->form_validation->set_rules('description', 'متن پست', 'required');
