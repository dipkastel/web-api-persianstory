...
class Home extends CI_Controller {
	...
	public function index()
	{
		...
		$data['posts'] = $this->model_home->get_dataMpages('tg_dastan',6,0);
		$data['popular'] = $this->model_home->get_popular();
		$dataHead['title'] = 'قصه های بهار | قصه برای بچه ها';
